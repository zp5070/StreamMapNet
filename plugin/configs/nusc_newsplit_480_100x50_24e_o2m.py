...
model = dict(
    ...
    head_cfg=dict(
        ...
        num_vec_one2many=num_vec_one2one*k_one2many,
        ...
        streaming_cfg=dict(
            ...
            topk=int(num_vec_one2one*(1/3)),
            trans_loss_weight=0.1,
        ),
        streaming_cfg_one2many=dict(
            streaming=True,
            batch_size=batch_size,
            topk=int(num_vec_one2one*k_one2many*(1/3)),
            trans_loss_weight=0.1,
        ),
        transformer=dict(
            type='MapTransformer',
...
eval_config = dict(
    ...
    ann_file='./datasets/streammapnet/nuscenes_map_infos_val_newsplit_w_lidar.pkl',
    meta=meta,
    roi_size=roi_size,
    cat2id=cat2id,
    pipeline=[
...
data = dict(
    ...
    train=dict(
        type='NuscDataset',
        data_root='./datasets/nuScenes',
        ann_file='./datasets/streammapnet/nuscenes_map_infos_train_newsplit_w_lidar.pkl',
        meta=meta,
        roi_size=roi_size,
        cat2id=cat2id,
